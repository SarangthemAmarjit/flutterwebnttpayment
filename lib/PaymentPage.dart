...
import 'package:flutter_web_kit/constant/constant.dart';
import 'package:flutter_web_kit/controller/tapcontroller.dart';
import 'package:flutter_web_kit/successpage.dart';
...
class _PaymentFinalPageState extends State<PaymentFinalPage> {
  ...
  void loadHtml(InAppWebViewController controller) {
    String htmlContent = """
      <!DOCTYPE html>
      <html lang="en">
      <head>
          ...
          <script>
              ...
              cdnScript.onload = function() {
                  console.log('✅ Atom script loaded successfully');
              };
              cdnScript.onerror = function() {
                  console.error('❌ Failed to load Atom script');
              };
      ...
      <body>
          ...
          <script>
              function waitForAtomPaynetz(callback) {
              ...
              function openPay(payDetails) {
                  ...
                  waitForAtomPaynetz(() => {
                      console.log("✅ AtomPaynetz loaded, initializing payment...");
